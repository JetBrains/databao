...
from databao_agent.core.executor import ExecutionResult, OutputModalityHints
from databao_agent.core.opa import Opa
from databao_agent.core.visualizer import VisualisationResult
...
class Thread:
    ...
    def html(self) -> str:
        ...
        """
        from databao_agent.multimodal import open_html_content
