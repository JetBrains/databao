...
dce_project = Path("/tmp/dbt-agent-test")
# NOTE: (@gas) to re-create context on every run
if dce_project.exists():
    shutil.rmtree(dce_project)
dce_project.mkdir(parents=True, exist_ok=True)
